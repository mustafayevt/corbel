...
namespace Corbel.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_notes_asp_net_users_owner_id",
                        column: x => x.owner_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_notes_owner_id_created_at_utc",
                table: "notes",
                columns: new[] { "owner_id", "created_at_utc" });
